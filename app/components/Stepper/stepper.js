                    ...
                    <div className="content-wrapper font-medium text-5xl">
                        ...
                        >
                            ...
                            <form action="" className="my-4">
                                <input type="radio" name="q1" id="yes" defaultChecked onChange={handleRadioChange} />
                                <label htmlFor="yes">Yes</label>
        
                                <input type="radio" name="q1" id="no" className="ms-5" onChange={handleRadioChange} />
                        ...
                        {error ? <p className="text-[#FF0000] font-semibold">{error} </p> : <></>}
                        </div>
                    </div>
                    </div>
